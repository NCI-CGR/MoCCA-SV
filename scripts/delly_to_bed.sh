...
cmd_get_end2_coords="awk '{FS=OFS=\"\\t\"} {chr=gensub(/.*;CHR2=([chrNCGLhs37d_]*[0-9MTXY.]+);.*/, \"\\\\1\", \"g\"); pos1=gensub(/.*;END=([0-9]+);.*/, \"\\\\1\", \"g\")} (pos1!=0){print chr,pos1-1,pos1,\$NF} (pos1==0){print chr,pos1,pos1+1,\$NF}'"
